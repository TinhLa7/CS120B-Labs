...
#include <avr/io.h>
#define button1 GetBit(tmpA, 0)
#define button2 GetBit(tmpA, 1)
//global variables
unsigned char tmpA;
unsigned char tmpB;

enum States {Start, Init, Nuetral, FirstButtonPress, SecondButtonPress, BothButtonsPress} state;
...
// TODO: Rename states to match diagram
